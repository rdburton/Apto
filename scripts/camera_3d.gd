...
func _process(delta: float) -> void:
	...
	#Reset camera position
		...
		global_position.x = lerp(global_position.x, (player.global_position.x + camera_offset), 0.01)
		global_position.y = lerp(global_position.y, (player.global_position.y + camera_offset), 0.01)
		global_position.z = lerp(global_position.z, (player.global_position.z + camera_offset), 0.01)
